{
  ...
  outputs = { self, nixpkgs, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        sources = {
          "@asyncapi/specs-2.14.0" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/@asyncapi/specs/-/specs-2.14.0.tgz";
              sha512 =
          ...
          "@jsep-plugin/regex-1.0.2" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/@jsep-plugin/regex/-/regex-1.0.2.tgz";
              sha512 =
          ...
          "@stoplight/json-3.17.0" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/@stoplight/json/-/json-3.17.0.tgz";
              sha512 =
          ...
          "@stoplight/json-3.17.2" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/@stoplight/json/-/json-3.17.2.tgz";
              sha512 =
          ...
          "@stoplight/path-1.3.2" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/@stoplight/path/-/path-1.3.2.tgz";
              sha512 =
          ...
          "@stoplight/types-12.3.0" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/@stoplight/types/-/types-12.3.0.tgz";
              sha512 =
          ...
          "@stoplight/types-12.5.0" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/@stoplight/types/-/types-12.5.0.tgz";
              sha512 =
          ...
          "@stoplight/types-13.0.0" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/@stoplight/types/-/types-13.0.0.tgz";
              sha512 =
          ...
          "@stoplight/yaml-4.2.2" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/@stoplight/yaml/-/yaml-4.2.2.tgz";
              sha512 =
          ...
          "ajv-errors-3.0.0" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/ajv-errors/-/ajv-errors-3.0.0.tgz";
              sha512 =
          ...
          "ast-types-0.14.2" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/ast-types/-/ast-types-0.14.2.tgz";
              sha512 =
          ...
          "fast-glob-3.2.7" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/fast-glob/-/fast-glob-3.2.7.tgz";
              sha512 =
          ...
          "get-source-2.0.12" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/get-source/-/get-source-2.0.12.tgz";
              sha512 =
          ...
          "jsonpointer-5.0.0" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/jsonpointer/-/jsonpointer-5.0.0.tgz";
              sha512 =
          ...
          "pony-cause-1.1.1" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/pony-cause/-/pony-cause-1.1.1.tgz";
              sha512 =
          ...
          "simple-eval-1.0.0" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/simple-eval/-/simple-eval-1.0.0.tgz";
              sha512 =
          ...
          "stacktracey-2.1.8" = {
            ...
            src = pkgs.fetchurl {
              url =
                "https://registry.npmjs.org/stacktracey/-/stacktracey-2.1.8.tgz";
              sha512 =
      ...
      in rec {
        packages.default = nodeEnv.buildNodePackage {
